...
insert into drtu_old.dev (id_obj, devid, num, myear, ps, d_create, id, d_nkip, d_tkip, t_zam, obj_code,
                      ok_send, opcl, tid_pr, tid_rg, scode, detail)
values (10110230001100, 10708310, '00000002', '1980', 11, null, 100002, '2092-12-22', '2017-12-22', 900, '1011023',
        null, null, null, null, null, null);
insert into drtu_old.dev (id_obj, devid, num, myear, ps, d_create, id, d_nkip, d_tkip, t_zam, obj_code,
                      ok_send, opcl, tid_pr, tid_rg, scode, detail)
values (null, 10708310, '00000003', '1981', 21, null, 100003, '2092-12-22', '2017-12-22', 900, '1011023',
        null, null, null, null, null, null);
insert into drtu_old.dev (id_obj, devid, num, myear, ps, d_create, id, d_nkip, d_tkip, t_zam, obj_code,
                      ok_send, opcl, tid_pr, tid_rg, scode, detail)
values (null, 10708310, '00000004', '1982', 32, null, 100004, '2092-12-22', '2017-12-22', 900, '1011',
        null, null, null, null, null, null);
